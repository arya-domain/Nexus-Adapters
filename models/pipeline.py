...
from models.adapter import NexusAdapter, MultiAdapter
...
class StableDiffusionAdapterPipeline(DiffusionPipeline, StableDiffusionMixin):
    ...
    Args:
        adapter ([`NexusAdapter`] or [`MultiAdapter`] or `List[NexusAdapter]`):
    ...
    def __init__(
        ...
        adapter: Union[NexusAdapter, MultiAdapter, List[NexusAdapter]],
        ...
        if safety_checker is None and requires_safety_checker:
            print('You have disabled the safety checker for')
            logger.warning(
    ...
    def __call__(
        ...
        if isinstance(self.adapter, MultiAdapter):
            ...
            adapter_state = self.adapter(adapter_input, prompt_embeds)
            for k, v in enumerate(adapter_state):
